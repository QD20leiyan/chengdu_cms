<?php
if (YII_DEV) {
    define('STATIC_DOMAIN','http://static.dev.yingxiong.com/hqwm/');
    define('VERSION', time());
} else if (YII_DEMO) {
    define('STATIC_DOMAIN','http://dev.static.yingxiong.com/dev/hqwm/');
    define('VERSION', time());
} else {
    define('STATIC_DOMAIN','http://cdnstatic.yingxiong.com/hqwm/');
...
//                'm/<controller:\w+>/<action:\w+>'=>'wap/<controller>/<action>',  //注释掉了 这个2.0中已经用不到了
                'index'=>'site/index',
                'cover'=>'site/cover',
                'part/<name:ppcpc|stpc|jpcpc|360pc|sgpc|smpc|t>'=>'site/cover',
                'part/m/<name:ppcwap|stwap|jpcwap|360wap|sgwap|smwap>'=>'wap/site/cover',
            ],
        ],
        'view' => [
