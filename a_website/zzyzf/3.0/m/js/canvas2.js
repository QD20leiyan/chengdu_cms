...
$(function(){
  ...
  var imgurls2=["lt1.png","lt2.png","lt3.png","lt4.png","lt5.png","lt6.png","lt7.png","lt8.png","lt9.png","lt10.png","lt11.png","lt12.png","lt13.png","lt14.png","lt15.png","lt16.png"];
  ...
  var imgs=[];
  for(var i in imgurls2){
    var img=document.createElement("img");
    img.src=baseurl+imgurls2[i];
    imgs.push(img);
  }
  function childFun(){
    var i=0;
    var childDom=document.getElementById("child2");
