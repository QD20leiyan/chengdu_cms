...
function getIcon() {
	$.ajax({
		...
		success: function(respon) {
			...
			$(".icon").attr("src", data.data.info.website_logo_img.value);
			$(".header_txt p:nth-child(1)").text(data.data.info.website_title.value);
			$(".header_txt p:nth-child(2)").text(data.data.info.website_sub_title.value);
			$(".header_txt p:nth-child(1)").attr("style", data.data.info.website_title_style.value);
			$(".header_txt p:nth-child(2)").attr("style", data.data.info.website_sub_title_style.value);
	...
	$.ajax({
		...
		success: function(respon) {
			...
			if(data.data.info.nav_background_img.value == "" || data.data.info.nav_background_img.value == undefined) {
				$("#bg_top").css("background", data.data.info.nav_background_color.value);
...
function getKv() {
	$.ajax({
		url: alt + "moduleapi/kv/get-background-info",
		type: 'POST',
		async: true,
		xhrFields: {
			withCredentials: true
		...
		success: function(respon) {
			var data = eval(respon);
			$("#bg_kv").css({
				"background": 'url(' + data.data.info.kv_background_img.value + ')',
				"background-repeat": "no-repeat",
				"background-position": "center"
			});
			var html = "";
			for(var i in data.data.info.kv_background_img.img_log) {
				html += '<li data-id=' + data.data.info.kv_background_img.img_log[i].id + ' data-title=' + data.data.info.kv_background_img.img_log[i].name + '><img src=' + data.data.info.kv_background_img.img_log[i].img + ' /><i class="gou"></i><p>预览</p></li>';
			};
			var str = '<li data-id=' + data.data.info.kv_background_img.id + ' data-title=' + data.data.info.kv_background_img.key + '><img src=' + data.data.info.kv_background_img.value + ' /><i class="gou"></i><p>预览</p></li>'
			if(html == "" || html == undefined) {
				$("#qimg_ul").html(null).append(str);
				$("#qimg_ul li").removeClass("active");
				$("#qimg_ul li:nth-child(1)").addClass("active");
			} else {
				$("#qimg_ul").html(null).append(html + str);
				$("#qimg_ul li").removeClass("active");
				$("#qimg_ul li:nth-child(1)").addClass("active");
			}
		},
...
$("#kv_sure").click(function() {
	$.ajax({
		url: alt + "moduleapi/kv/update-background",
		type: 'POST',
		async: true,
		xhrFields: {
			withCredentials: true
		...
		data: {
			"kv_background_img": $("#qimg_ul li.active img").attr("src"),
			"kv_background_img_log[0][name]": $("#qimg_ul li.active").attr("data-title"),
			"kv_background_img_log[0][img]": $("#qimg_ul li.active img").attr("src"),
		},
		success: function(respon) {
			var data = eval(respon);
			if(respon.status == 0) {
...
function getVideo() {
	$.ajax({
		...
		success: function(respon) {
			var data = eval(respon);
			$("#kv_video").attr("src", data.data.info.kv_video_button_img.value);
			$("#kv_video").attr("data-url", data.data.info.kv_video_url.value);
...
function getYy() {
	$.ajax({
		...
		success: function(respon) {
			var data = eval(respon);
			$("#kv_yuyue img").attr("src", data.data.info.kv_yuyue_module_botton_img.value);
			$("#yy_number").text(data.data.stat.count);
...
function getTc() {
	$.ajax({
		...
		success: function(respon) {
			...
			$(".wx_icon").attr("src", data.data.info.kv_yuyuepopup_platform_no_select_icon.value);
			$(".yx_icon").attr("src", data.data.info.kv_yuyuepopup_platform_select_icon.value);
...
function getSecond() {
	$.ajax({
		url: alt + "moduleapi/progress/get-background-info",
		type: 'POST',
		async: true,
		xhrFields: {
			withCredentials: true
		...
		success: function(respon) {
			var data = eval(respon);
			$(".content").css({
				"background": 'url(' + data.data.info.progress_background_img.value + ')',
				"background-repeat": "no-repeat",
				"background-position": "center"
			});
			$(".label_info").text(data.data.info.progress_background_summary.value);
			$(".label_info").attr("style", data.data.info.progress_background_summary_style.value);
			$("#conduct").text(data.data.info.progress_background_summary.value);
			$("#conduct").attr("style", data.data.info.progress_background_summary_style.value);
			var html = "";
			for(var i in data.data.info.progress_background_img.img_log) {
				html += '<li data-id=' + data.data.info.progress_background_img.img_log[i].id + ' data-title=' + data.data.info.progress_background_img.img_log[i].name + '><img src=' + data.data.info.progress_background_img.img_log[i].img + ' /><i class="gou"></i><p>预览</p></li>';
			};
			var str = '<li data-id=' + data.data.info.progress_background_img.id + ' data-title=' + data.data.info.progress_background_img.key + '><img src=' + data.data.info.progress_background_img.value + ' /><i class="gou"></i><p>预览</p></li>'
			if(html == "" || html == undefined) {
...
$("#jd_sure").click(function() {
	...
	$.ajax({
		...
		data: {
			"progress_background_img": $("#nimg_ul li.active img").attr("src"),
			"progress_background_img_log[0][name]": $("#nimg_ul li.active").attr("data-title"),
			"progress_background_img_log[0][img]": $("#nimg_ul li.active img").attr("src"),
...
function getJimg() {
	$.ajax({
		...
		success: function(respon) {
			var data = eval(respon);
			$("#jd_yy img").attr("src", data.data.info.progress_yuyue_botton_img.value);
			var html = "";
			for(var i in data.data.info.progress_yuyue_botton_img.img_log) {
				html += '<li data-id=' + data.data.info.progress_yuyue_botton_img.img_log[i].id + ' data-title=' + data.data.info.progress_yuyue_botton_img.img_log[i].name + '><img src=' + data.data.info.progress_yuyue_botton_img.img_log[i].img + ' /><i class="gou"></i><p>预览</p></li>';
			};
			var str = '<li data-id=' + data.data.info.progress_yuyue_botton_img.id + ' data-title=' + data.data.info.progress_yuyue_botton_img.key + '><img src=' + data.data.info.progress_yuyue_botton_img.value + ' /><i class="gou"></i><p>预览</p></li>'
			if(html == "" || html == undefined) {
...
$("#bt_sure").click(function() {
	$.ajax({
		...
		data: {
			"progress_yuyue_botton_img": $("#rimg_ul li.active img").attr("src"),
			"progress_yuyue_botton_img_log[0][name]": $("#rimg_ul li.active").attr("data-title"),
			"progress_yuyue_botton_img_log[0][img]": $("#rimg_ul li.active img").attr("src"),
		},
		success: function(respon) {
			var data = eval(respon);
			if(respon.status == 0) {
...
function getJd() {
	$.ajax({
		url: alt + "moduleapi/progress/get-bar-info",
		type: 'POST',
		async: true,
		xhrFields: {
			withCredentials: true
		...
		success: function(respon) {
			var data = eval(respon);
			$(".line").css({
				"background": 'url(' + data.data.info.progress_bar_background_img.value + ')',
				"background-repeat": "no-repeat",
				"background-position": "center"
			});
			$(".jdt").css({
				"background": 'url(' + data.data.info.progress_bar_fill_img.value + ')',
				"background-repeat": "no-repeat",
				"background-position": "center"
			});
			var html = "";
			for(var i in data.data.info.progress_bar_background_img.img_log) {
				html += '<li data-id=' + data.data.info.progress_bar_background_img.img_log[i].id + ' data-title=' + data.data.info.progress_bar_background_img.img_log[i].name + '><img src=' + data.data.info.progress_bar_background_img.img_log[i].img + ' /><i class="gou"></i><p>预览</p></li>';
			};
			var str = '<li data-id=' + data.data.info.progress_bar_background_img.id + ' data-title=' + data.data.info.progress_bar_background_img.key + '><img src=' + data.data.info.progress_bar_background_img.value + ' /><i class="gou"></i><p>预览</p></li>'
			if(html == "" || html == undefined) {
			...
			var bhtml = "";
			for(var i in data.data.info.progress_bar_fill_img.img_log) {
				html += '<li data-id=' + data.data.info.progress_bar_fill_img.img_log[i].id + ' data-title=' + data.data.info.progress_bar_fill_img.img_log[i].name + '><img src=' + data.data.info.progress_bar_fill_img.img_log[i].img + ' /><i class="gou"></i><p>预览</p></li>';
			};
			var bstr = '<li data-id=' + data.data.info.progress_bar_fill_img.id + ' data-title=' + data.data.info.progress_bar_fill_img.key + '><img src=' + data.data.info.progress_bar_fill_img.value + ' /><i class="gou"></i><p>预览</p></li>'
...
$("#ti_sure").click(function() {
	$.ajax({
		url: alt + "moduleapi/progress/update-bar",
		type: 'POST',
		async: true,
		xhrFields: {
			withCredentials: true
		...
		data: {
			"progress_bar_background_img": $("#zimg_ul li.active img").attr("src"),
			"progress_bar_background_img_log[0][name]": $("#zimg_ul li.active").attr("data-title"),
			"progress_bar_background_img_log[0][img]": $("#zimg_ul li.active img").attr("src"),
			"progress_bar_fill_img": $("#ximg_ul li.active img").attr("src"),
			"progress_bar_fill_img_log[0][name]": $("#ximg_ul li.active").attr("data-title"),
			"progress_bar_fill_img_log[0][img]": $("#ximg_ul li.active img").attr("src"),
		},
		success: function(respon) {
			var data = eval(respon);
			if(respon.status == 0) {
...
function getJie() {
	$.ajax({
		...
		success: function(respon) {
			var data = eval(respon);
			$(".first .p_img img").attr("src", data.data.info.progress_node_1_img.value);
			$(".first .info").html(data.data.info.progress_node_1_summary.value);
			$("#fr_value").val(data.data.info.progress_node_1_summary.value);
			$("#fr_num").val(data.data.info.progress_node_1_num.value);
			$(".second .p_img img").attr("src", data.data.info.progress_node_2_img.value);
			$(".second .info").html(data.data.info.progress_node_2_summary.value);
			$("#se_value").val(data.data.info.progress_node_2_summary.value);
			$("#se_num").val(data.data.info.progress_node_2_num.value);
			$(".third .p_img img").attr("src", data.data.info.progress_node_3_img.value);
			$(".third .info").html(data.data.info.progress_node_3_summary.value);
			$("#th_value").val(data.data.info.progress_node_3_summary.value);
			$("#th_num").val(data.data.info.progress_node_3_num.value);
			$(".four .p_img img").attr("src", data.data.info.progress_node_4_img.value);
			$(".four .info").html(data.data.info.progress_node_4_summary.value);
			$("#fo_value").val(data.data.info.progress_node_4_summary.value);
			$("#fo_num").val(data.data.info.progress_node_4_num.value);
			$(".five .p_img img").attr("src", data.data.info.progress_node_5_img.value);
			$(".five .info").html(data.data.info.progress_node_5_summary.value);
			...
			$(".first .info").attr("style", data.data.info.progress_node_1_summary_style.value);
			$("#se_value").attr("style", data.data.info.progress_node_2_summary_style.value);
			$(".second .info").attr("style", data.data.info.progress_node_2_summary_style.value);
			$("#th_value").attr("style", data.data.info.progress_node_3_summary_style.value);
			$(".third .info").attr("style", data.data.info.progress_node_3_summary_style.value);
			$("#fo_value").attr("style", data.data.info.progress_node_4_summary_style.value);
			$(".four .info").attr("style", data.data.info.progress_node_4_summary_style.value);
			$("#ve_value").attr("style", data.data.info.progress_node_5_summary_style.value);
			$(".five .info").attr("style", data.data.info.progress_node_5_summary_style.value);
			var html = "";
...
function getDown() {
	$.ajax({
		url: alt + "moduleapi/bottommedia/get-download-info",
		type: 'POST',
		async: true,
		xhrFields: {
			withCredentials: true
		...
		success: function(respon) {
			var data = eval(respon);
			$("#down_ewm").attr("src", data.data.info.bottommedia_download_ewm.value);
			$("#d_title01").text(data.data.info.bottommedia_download_title.value);
			$("#d_title02").text(data.data.info.bottommedia_download_sub_title.value);
			$("#d_title01").attr(data.data.info.bottommedia_download_title_style.value);
			$("#d_title02").attr(data.data.info.bottommedia_download_sub_title_style.value);
			$("#f_title01").val(data.data.info.bottommedia_download_title.value);
			$("#f_title02").val(data.data.info.bottommedia_download_sub_title.value);
			$("#f_title01").attr("style", data.data.info.bottommedia_download_title_style.value);
			$("#f_title02").attr("style", data.data.info.bottommedia_download_sub_title_style.value);
			var html = "";
			for(var i in data.data.info.bottommedia_download_ewm.img_log) {
				html += '<li data-id=' + data.data.info.bottommedia_download_ewm.img_log[i].id + ' data-title=' + data.data.info.bottommedia_download_ewm.img_log[i].name + '><img src=' + data.data.info.bottommedia_download_ewm.img_log[i].img + ' /><i class="gou"></i><p>预览</p></li>';
			};
			var str = '<li data-id=' + data.data.info.bottommedia_download_ewm.id + ' data-title=' + data.data.info.bottommedia_download_ewm.key + '><img src=' + data.data.info.bottommedia_download_ewm.value + ' /><i class="gou"></i><p>预览</p></li>'
			if(html == "" || html == undefined) {
				$("#d_ul").html(null).append(str);
				$("#d_ul li").removeClass("active");
				$("#d_ul li:nth-child(1)").addClass("active");
			} else {
				$("#d_ul").html(null).append(html);
				$("#d_ul li").removeClass("active");
				$("#d_ul li:nth-child(1)").addClass("active");
			}
		},
...
function getNewsBg(){
	...
	$.ajax({
		...
		success: function(respon) {
			var data = eval(respon);
			$(".second").css({
				"background": 'url(' + data.data.news.info.news_background_img.value + ')',
				"background-repeat": "no-repeat",
				"background-position": "center"
			});
			var html = "";
			for(var i in data.data.news.info.news_background_img.img_log) {
				html += '<li data-id=' + data.data.news.info.news_background_img.img_log[i].id + ' data-title=' + data.data.news.info.news_background_img.img_log[i].name + '><img src=' + data.data.news.info.news_background_img.img_log[i].img + ' /><i class="gou"></i><p>预览</p></li>';
			};
			var str = '<li data-id=' + data.data.news.info.news_background_img.id + ' data-title=' + data.data.news.info.news_background_img.key + '><img src=' + data.data.news.info.news_background_img.value + ' /><i class="gou"></i><p>预览</p></li>'
			if(html == "" || html == undefined) {
				$("#ne_ul").html(null).append(str);
				$("#ne_ul li").removeClass("active");
				$("#ne_ul li:nth-child(1)").addClass("active");
			} else {
				$("#ne_ul").html(null).append(html);
				$("#ne_ul li").removeClass("active");
				$("#ne_ul li:nth-child(1)").addClass("active");
			}
		},
...
$("#ne_sure").click(function (){
	...
	$.ajax({
		...
		data: {
			"news_background_img": $("#ne_ul li.active img").attr("src"),
			"news_background_img_log[0][name]": $("#ne_ul li.active").attr("data-title"),
			"news_background_img_log[0][img]": $("#ne_ul li.active img").attr("src"),
			group : group
		},
		success: function(respon) {
			var data = eval(respon);
...
function getTese() {
	$.ajax({
		url: alt + "moduleapi/tese/get-background-info",
		type: 'POST',
		async: true,
		xhrFields: {
			withCredentials: true
		...
		success: function(respon) {
			var data = eval(respon);
			$(".last").css({
				"background": 'url(' + data.data.info.tese_background_img.value + ')',
				"background-repeat": "no-repeat",
				"background-position": "center"
			});
			var html = "";
			for(var i in data.data.info.tese_background_img.img_log) {
				html += '<li data-id=' + data.data.info.tese_background_img.img_log[i].id + ' data-title=' + data.data.info.tese_background_img.img_log[i].name + '><img src=' + data.data.info.tese_background_img.img_log[i].img + ' /><i class="gou"></i><p>预览</p></li>';
			};
			var str = '<li data-id=' + data.data.info.tese_background_img.id + ' data-title=' + data.data.info.tese_background_img.key + '><img src=' + data.data.info.tese_background_img.value + ' /><i class="gou"></i><p>预览</p></li>'
			if(html == "" || html == undefined) {
...
$("#ts_sure").click(function() {
	$.ajax({
		url: alt + "moduleapi/tese/update-background",
		type: 'POST',
		async: true,
		xhrFields: {
			withCredentials: true
		...
		data: {
			"tese_background_img": $("#te_ul li.active img").attr("src"),
			"tese_background_img_log[0][name]": $("#te_ul li.active").attr("data-title"),
			"tese_background_img_log[0][img]": $("#te_ul li.active img").attr("src"),
		},
		success: function(respon) {
			var data = eval(respon);
			if(respon.status == 0) {
		...
		success: function(respon) {
			...
			for(var i in data.data.data) {
				if(i < 5) {
					...
					bhtml += '<li class="swiper-slide" data-id=' + data.data.data[i].id + '><img src=' + data.data.data[i].thumb + ' /><i></i></li>';
					chtml += '<li class="swiper-slide" data-id=' + data.data.data[i].id + '><a href="javascript:;"><img src=' + data.data.data[i].thumb + ' /></a></li>';
				}
			};
			$(".d_play .swiper-wrapper").html(null).append(bhtml);
			$(".m_banner .swiper-wrapper").html(null).append(bhtml);
			$(".bottom_banner .swiper-wrapper").html(null).append(chtml);
			$("#lb_ul").html(null).append(html);
			$("#lb_ul li").addClass("active");
			var mySwiper01 = new Swiper(".d_play", {
				loop: true,
				autoplay: 4500,
...
function getVbg() {
	...
	$.ajax({
		...
		success: function(respon) {
			var data = eval(respon);
			var html = "";
			for(var i in data.data.videobackground.info.videobackground_background_img.img_log) {
				html += '<li data-id=' + data.data.videobackground.info.videobackground_background_img.img_log[i].id + ' data-title=' + data.data.videobackground.info.videobackground_background_img.img_log[i].name + '><img src=' + data.data.videobackground.info.videobackground_background_img.img_log[i].img + ' /><i class="gou"></i><p>预览</p></li>';
			};
			var str = '<li data-id=' + data.data.videobackground.info.videobackground_background_img.id + ' data-title=' + data.data.videobackground.info.videobackground_background_img.key + '><img src=' + data.data.videobackground.info.videobackground_background_img.value + ' /><i class="gou"></i><p>预览</p></li>'
			$(".flower").css({
				"background": 'url(' + data.data.videobackground.info.videobackground_background_img.value + ')',
				"background-repeat": "no-repeat",
				"background-position": "center",
				"background-size": "100% 100%"
			});
...
$("#ad_v_sure").click(function() {
	...
	$.ajax({
		...
		data: {
			"videobackground_background_img": $("#ad_v_bg li.active img").attr("src"),
			"videobackground_background_img_log[0][name]": $("#ad_v_bg li.active").attr("data-title"),
			"videobackground_background_img_log[0][img]": $("#ad_v_bg li.active img").attr("src"),
			group: videobackground,
		},
		success: function(respon) {
			var data = eval(respon);
...
function getNews() {
	...
	$.ajax({
		...
		success: function(respon) {
			var data = eval(respon);
			var html = "";
			for(var i in data.data.subpagekv.info.subpagekv_background_img.img_log) {
				html += '<li data-id=' + data.data.subpagekv.info.subpagekv_background_img.img_log[i].id + ' data-title=' + data.data.subpagekv.info.subpagekv_background_img.img_log[i].name + '><img src=' + data.data.subpagekv.info.subpagekv_background_img.img_log[i].img + ' /><i class="gou"></i><p>预览</p></li>';
			};
			var str = '<li data-id=' + data.data.subpagekv.info.subpagekv_background_img.id + ' data-title=' + data.data.subpagekv.info.subpagekv_background_img.key + '><img src=' + data.data.subpagekv.info.subpagekv_background_img.value + ' /><i class="gou"></i><p>预览</p></li>'
			if(html == "" || html == undefined) {
...
$("#news_sure").click(function() {
	...
	$.ajax({
		...
		data: {
			"subpagekv_background_img": $("#newsimg_ul li.active img").attr("src"),
			"subpagekv_background_img_log[0][name]": $("#newsimg_ul li.active").attr("data-title"),
			"subpagekv_background_img_log[0][img]": $("#newsimg_ul li.active img").attr("src"),
			group: subpagekv,
		},
		success: function(respon) {
			var data = eval(respon);
			...
			if(data.status == 0) {
				...
				for(var i in data.data) {
					html += '<li data-id=' + data.data[i].id + ' data-type=' + data.data[i].category_id + '>' +
						'<div class="video_bg" data-url=' + data.data[i].contentMessage + '>' +
						'<img src=' + data.data[i].thumb + ' alt="" class="video_img" />' +
						'<img src="' + alt02 + 'images/f_play.png" alt="" class="f_play js_video_play" /><i></i></div>' +
				...
				$(".fl_video").html(null).append(html);
...
function getPageSet() {
	$.ajax({
		...
		success: function(respon) {
			var data = eval(respon);
			$('meta[name="keywords"]').attr('content', data.data.info.web_key.value);
			$('meta[name="description"]').attr('content', data.data.info.web_desc.value);
			$(document).attr("title", data.data.info.web_title.value);
			...
			$('#link_href').attr("href", data.data.info.web_icon.value);
			var html = "";
	...
	$.ajax({
		...
		success: function(respon) {
			...
			if(data.data.info.public_button_js.value == 1) {
				$("#sf_di").append('<script type="text/javascript" src="http://cdnstatic.yingxiong.com/footer/js/footer_new.js"></script>');
				$(".pr_put>.se_pub:nth-child(2)").addClass("active");
			} else {
				$("#sf_di").html(null);
			}
			$("body").append(data.data.web_count);
		},
		error: function() {
...
$("#g_sure").click(function() {
	...
	var pub_footer = $(".pr_put>.se_pub:nth-child(2)").attr("data-type");
