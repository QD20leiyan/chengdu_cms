    ...
    function(a) {
        a.Editable.commands = a.extend(a.Editable.commands, {
            ...
            a.Editable.prototype.buildFileDrag = function() {
                var b = this;
                b.$file_wrapper.on("dragover", "#f-file-upload-div-" + this._id,
                    function() {
                        return a(this).addClass("f-hover"),
                            !1
                    }),
                    b.$file_wrapper.on("dragend", "#f-file-upload-div-" + this._id,
                        function() {
                            return a(this).removeClass("f-hover"),
                                !1
                        }),
                    b.$file_wrapper.on("drop", "#f-file-upload-div-" + this._id,
                        function(c) {
                            c.preventDefault(),
                                c.stopPropagation(),
            ...
            a.Editable.prototype.uploadFile = function(b) {
                ...
                if (void 0 !== b && b.length > 0) {
                    ...
                    if (this.drag_support.formdata && (c = this.drag_support.formdata ? new FormData: null), c) {
                        ...
                        if (c.append(this.options.fileUploadParam, b[0]), b[0].size > this.options.maxFileSize) return this.throwFileError(5),
                            !1;
                        if (this.options.allowedFileTypes.indexOf(b[0].type) < 0 && this.options.allowedFileTypes.indexOf("*") < 0) return this.throwFileError(6),
                            !1
                    }
                    if (c) {
                        var e;
            ...
            a.Editable.prototype.parseFileResponse = function(b, c) {
                try {
                    var d = a.parseJSON(b);
                    d.link ? this.writeFile("file:///C:/Users/Administrator/Desktop/2.0/common/images/logo.png", c) : d.error ? this.throwFileErrorWithMessage(d.error) : this.throwFileError(2)
                } catch(e) {
                    this.throwFileError(4)
                }
            },
            a.Editable.prototype.writeFile = function(a, b) {
                this.restoreSelectionByMarkers(),
                    ...
                    this.saveUndoStep(),
                    this.focus(),
                    this.triggerEvent("fileUploaded", [b, a])
            }
    } (jQuery);