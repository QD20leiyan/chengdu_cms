...
! function (a) {
        ...
        this.$element.get(0).onpaste = a.proxy(function (b) {
            if (!this.isHTML) {
                ...
                if (b && b.clipboardData && b.clipboardData.getData) {
                    ...
                    else d = e; if (/text\/html/.test(d) ? this.clipboardHTML = b.clipboardData.getData("text/html") : /text\/rtf/.test(d) && this.browser.safari ? this.clipboardHTML = b.clipboardData.getData("text/rtf") : /text\/plain/.test(d) && (this.clipboardHTML = b.clipboardData.getData("text/plain").replace(/\n/g, "<br/>")), "" !== this.clipboardHTML ? c = !0 : this.clipboardHTML = null, c) return this.processPaste(), b.preventDefault && (b.stopPropagation(), b.preventDefault()), !1
                }
                this.beforePaste()
            }
        }, this)
    ...
    function (a) {
        a.Editable.image_commands = {
            ...
            try {
                var c = a.parseJSON(b);
                c.file_url ? this.writeImage(c.file_url) : c.error ? this.throwImageErrorWithMessage(c.error) : this.throwImageError(2)
            } catch (d) {
                this.throwImageError(4)
            }
