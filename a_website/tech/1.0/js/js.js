...
$(".p_textarea").focus(function(){
	$(".p_textarea").removeAttr("readonly");
	$(".p_textarea").addClass("on");
});
$(".p_textarea").blur(function(){
	$(".p_textarea").attr("readonly","readonly");
	$(".p_textarea").removeClass("on");
})

$(".add-radio ul li").click(function(){
