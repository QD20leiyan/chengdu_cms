	...
	$.Gallery.prototype 	= {
		...
		_layout				: function() {
			...
			if( this.support3d && this.supportTrans ) {
				...
				leftCSS 	= {
					'-webkit-transform'	: 'translateX(-250px) translateZ(-200px) rotateY(45deg)',
					'-moz-transform'	: 'translateX(-250px) translateZ(-200px) rotateY(45deg)',
					'-o-transform'		: 'translateX(-250px) translateZ(-200px) rotateY(45deg)',
					'-ms-transform'		: 'translateX(-250px) translateZ(-200px) rotateY(45deg)',
