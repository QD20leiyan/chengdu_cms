...
function change(){
	...
	console.log(url_id);
   //if(isIOS) {
	//   $(".go-website1").attr("href","https://itunes.apple.com/cn/app/id1318073121");
	//   $(".go-website1").removeClass("hidden");
   //}else{
	//   $(".go-website1").addClass("hidden");
   //}
		...
		success:function(data){
			if(data.status==0){
				...
				if(data.data.countInv==1){
					$(".index-wrap .page4 .progress-bar2 .each:eq(0) p").addClass("bar");
				}else if(data.data.countInv==5){
					$(".index-wrap .page4 .progress-bar2 .each:eq(0) p,.index-wrap .page4 .progress-bar2 .each:eq(1) p").addClass("bar");
				}else if(data.data.countInv==10){
					$(".index-wrap .page4 .progress-bar2 .each:eq(0) p,.index-wrap .page4 .progress-bar2 .each:eq(1) p,.index-wrap .page4 .progress-bar2 .each:eq(2) p").addClass("bar");
				}else if(data.data.countInv==30){
					$(".index-wrap .page4 .progress-bar2 .each:eq(0) p,.index-wrap .page4 .progress-bar2 .each:eq(1) p").addClass("bar");
					$(".index-wrap .page4 .progress-bar2 .each:eq(2) p,.index-wrap .page4 .progress-bar2 .each:eq(3) p").addClass("bar");
				}else if(data.data.countInv==50){
					$(".index-wrap .page4 .progress-bar2 .each:eq(0) p,.index-wrap .page4 .progress-bar2 .each:eq(1) p").addClass("bar");
					$(".index-wrap .page4 .progress-bar2 .each:eq(2) p,.index-wrap .page4 .progress-bar2 .each:eq(3) p,.index-wrap .page4 .progress-bar2 .each:eq(4) p").addClass("bar");

				}else if(data.data.countInv==100){
					$(".index-wrap .page4 .progress-bar2 .each:eq(0) p,.index-wrap .page4 .progress-bar2 .each:eq(1) p,.index-wrap .page4 .progress-bar2 .each:eq(2) p").addClass("bar");
					$(".index-wrap .page4 .progress-bar2 .each:eq(3) p,.index-wrap .page4 .progress-bar2 .each:eq(4) p,.index-wrap .page4 .progress-bar2 .each:eq(5) p").addClass("bar");
				}
				...
				if(data.data.yuyueTotal<=300000){
					...
					$(".index-wrap .page2 .progress-bar1 .each:eq(0) p").addClass("bar");
					$(".index-wrap .page2 .progress-bar1 .each:eq(0) p span").css("height",wi+"%")
				}
				if(300000<data.data.yuyueTotal&&data.data.yuyueTotal<=500000){
					$(".index-wrap .page2 .progress-bar1 .each:eq(0) p,.index-wrap .page2 .progress-bar1 .each:eq(1) p").addClass("bar");
					var wi=((data.data.yuyueTotal-300000)/200000)*100;
					$(".index-wrap .page2 .progress-bar1 .each:eq(1) p span").css("height",wi+"%");
				}
				if(500000<data.data.yuyueTotal&&data.data.yuyueTotal<=1000000){
					$(".index-wrap .page2 .progress-bar1 .each:eq(0) p,.index-wrap .page2 .progress-bar1 .each:eq(1) p,.index-wrap .page2 .progress-bar1 .each:eq(2) p").addClass("bar");
					var wi=((data.data.yuyueTotal-500000)/500000)*100;
					$(".index-wrap .page2 .progress-bar1 .each:eq(2) p span").css("height",wi+"%");
				}
				if(1000000<data.data.yuyueTotal&&data.data.yuyueTotal<=2000000){
					$(".index-wrap .page2 .progress-bar1 .each:eq(0) p,.index-wrap .page2 .progress-bar1 .each:eq(1) p,.index-wrap .page2 .progress-bar1 .each:eq(2) p,.index-wrap .page2 .progress-bar1 .each:eq(3) p").addClass("bar");
					var wi=((data.data.yuyueTotal-1000000)/1000000)*100;
					$(".index-wrap .page2 .progress-bar1 .each:eq(3) p span").css("height",wi+"%");
				}
				if(2000000<data.data.yuyueTotal&&data.data.yuyueTotal<=5000000){
					$(".index-wrap .page2 .progress-bar1 .each:eq(0) p,.index-wrap .page2 .progress-bar1 .each:eq(1) p,.index-wrap .page2 .progress-bar1 .each:eq(2) p,.index-wrap .page2 .progress-bar1 .each:eq(3) p,.index-wrap .page2 .progress-bar1 .each:eq(4) p").addClass("bar");
					var wi=((data.data.yuyueTotal-2000000)/3000000)*100;
					$(".index-wrap .page2 .progress-bar1 .each:eq(4) p span").css("height",wi+"%");
				}
				if(data.data.yuyueTotal>5000000){
					$(".index-wrap .page2 .progress-bar1 .each p").addClass("bar");
					var wi=((data.data.yuyueTotal-5000000)/2000000)*100;
					$(".index-wrap .page2 .progress-bar1 .each:eq(5) p span").css("height",wi+"%");
				}
...
$(function(){
	...
	var mySwiper = new Swiper('.swiper-container', {
		...
		onSlideChangeEnd: function(swiper) {
			...
			$(".page5 .gift-box .each").removeClass('active').eq(swiper.realIndex).addClass('active');
		}
	});
	//获取分享链接中的邀请码
	...
	$.ajax({
		...
		success:function(data){
			if(data.status==0){
				...
				$(".index-wrap .page4 .progress-bar2 .each p").removeClass("bar");
