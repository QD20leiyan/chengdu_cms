...
(function (root, doc, factory) {
	...
	function baocun(){
		var gongsi = $("#companyName").val();
		var xiangmu = $("#projectName").val();
		...
		$.ajax({
            type:"post",
            url:"http://h5designer.com/apps/web/index.php?s=BaiduQuanJing/doSaveWork",
            data:{"projectName":str,"companyName":company,"signerBin":qianming,},
            dataType:"json",
            success:function(data){
            	if (data.errorcode > 0) {
            		$("#companyName").attr("value","");
            		$("#companyName").css("border","solid red 1px");
            		$("#projectName").attr("value","");
            		$("#projectName").css("border","solid red 1px");	
            	}else if (data.errorcode == 0) {
            			$("#companyName").css("border","solid #333 1px !important");
            			$("#projectName").css("border","solid #333 1px !important");
            		var id = data.data.id;
            		var url = "http://118.190.20.119:8092/download/linshi/overtime/fenxiang.html?id="+id;
					location.href = url;
            	}
