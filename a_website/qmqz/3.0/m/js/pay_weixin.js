...
function getRecord(obj){
	...
	$.post('/weixinpay/getAddress.html',{prize_id:prize_id},function(data){
	    var data = eval("("+data+")");
	    if(data == -1){
             $('#s_name').val("");
            $('#s_address').val("");
...
function checkTime(){
	...
	var endTime = '2016-06-12 20:00:00';
