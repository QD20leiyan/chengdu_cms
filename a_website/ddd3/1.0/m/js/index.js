...
$(".co_codebtn1").click(function(){
  ...
  hideErr(1);
  $.post(verify_url,{ "phone":my_phone,"captcha":captcha,"type":type_id,"unique_phone":"1","cms_csrf":srf },function(data){
    if(data.status == 0){
...
$(".co_tips_loginbtn").click(function(){
  ...
  $.ajax({
    'url':login_url1,
    'data':{'phone':my_phone,'yzm':co_codenum1,'type':type_id,"email":"","unique_phone":"1","cms_csrf":srf },
    'type':'POST',
    'dataType':'Json',
