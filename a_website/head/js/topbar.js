...
var Top = {
    ...
    website: {
        ...
        "mxhy.*.yingxiong.com": 106,
        "xxjt.*.yingxiong.com": 108,
    },
    content: '<div class="hero_head"><a class="hero_logo" href="http://yingxiong.com"></a><div class="hero_middle"><span class="hero_title">一切以玩家乐趣为依归</span></div><a id="top_banner_a"><img id="top_middle_img" style="display: none" class="middle_pic" src="" alt="" /></a><a target="_blank" class="middle_big_img" style="display: none"><img src="" alt="" /></a><div class="game_list_bar"><span>游戏列表<i></i></span><div class="game_list_box"><div class="box_bar"><span class="hotest"><i></i>热门推荐</span><span class="lastest"><i></i>最新推荐</span></div><ul></ul></div></div><div class="hero_right"><a class="hero_user" href="http://i.yingxiong.com/" target="_blank"><i></i>账号中心</a><a class="hero_help" href="http://kf.yingxiong.com/" target="_blank"><i></i>客服中心</a></div></div>',
    link: link
};
if(Top.isShow
