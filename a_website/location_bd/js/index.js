        ...
        var ni_name="";//昵称  
        var team_id="";//战队id
        var share_icon=imgurl+"images/share4.png";//分享图片
            ...
            $.ajax({
                ...
                success:function(data){
                    if(data.code==0){
                        ...
                        share_link="http://h5.dev.yingxiong.com/index/sm/jinli.html?team_id="+share_term_id;
                            if(data.data.is_captain){
                                $(".is_nocp").hide();
                                $(".kd_btn1").css("display","block");
                                share_icon=imgurl+"images/share1.png";//分享图片
                                share_title="我的"+data.data.name+"探险队就差你！";//分享文案
                                wx_o();
                            }else{
                                $(".kd_btn1").css("display","none");
                                $(".is_nocp").show();
                                share_icon=imgurl+"images/share2.png";//分享图片
                                share_title=data.data.name+"战队宇宙第一帅！我已经加入了，你呢?";//分享文案
                                wx_o();
                            }
                            if(data.data.num != null){
                                $(".swiper4 .rq_send1 .send1").html(data.data.num);
                            }else{
                                $(".swiper4 .rq_send1 .send1").html("0");
                            }
    ...
    function wx_o(){
        ...
        //选择排名榜
            ...
            $(".swiper3 .return1").click(function(){
                ...
                $(".swiper2").removeClass("hidden");
                HLog.push("sm_jinli_page2_map");
                share_icon=imgurl+"images/share4.png";//分享图片
                share_title="寻找创魔锦鲤，终身领福利！你也快来吧";//分享文案
                share_link="http://h5.yingxiong.com/index/sm/jinli.html";//分享描述
                wx_o();
            })
