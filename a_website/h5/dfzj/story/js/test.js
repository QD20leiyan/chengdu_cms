    ...
    //音乐视频初始化
        ...
        function audioAutoPlay2(){
            ...
            document.getElementById('music2').volume = .3;
            document.addEventListener("WeixinJSBridgeReady", function () {
                document.getElementById('music2').play();
                document.getElementById('music2').volume = .3;
            }, false);
        ...
        //切换音效
         function audioAutoPlay3(){
            ...
            document.getElementById('music3').volume = .5;
            document.addEventListener("WeixinJSBridgeReady", function () {
                document.getElementById('music3').play();
                document.getElementById('music3').volume = .3;
            }, false);
        }
        // 背景音效
        function audioAutoPlay1(){
    ...
    $(function() {
        ...
        //     lineLink    : 'http://h5.yingxiong.com/index/dfzj/plot.html'
        // };
        // wx.config({
        //     debug     : false,
        //     appId     : wx_conf.appId,
        ...
        // //用户礼包码
        function gift(){
            // $.post(gift_code, {"type":type_id}, function(data) {
            //         if(data.code=="0") {
    ...
    $(".music_img").click(function(){
        ...
        $(".an_51").click(function(){
            ...
            $(".page3").addClass("hidden");
            $(".page2").removeClass("hidden");
            str="#好友了解到你此行的目的也是为了巅峰战舰的图纸，于是他把钥匙送给了你";
            print(str);
        ...
        $(".an_31_31").click(function(){
            ...
            $(".page3").addClass("hidden");
            $(".page2").removeClass("hidden");
            str="#在争抢图纸的过程当中，敌军朝你开枪，大副为了救你，帮你挡下了子弹，倒在血泊中，而你成功逃脱";
            print(str);
