      ...
      function(data){
		...
		if(data.status == 2){
		  ...
		  _key = data.p_id;
			...
			var img_url = 'http://dev.static.yingxiong.com/qtdl/3.0/common/images/1212/'+data.p_id+'.png';
			$('#p_img').attr('src',img_url);
			if(data.p_id == 1){
				var p_name = '烈火-柯尔德图纸*5';
				var p_level = '三等奖';
			}else if(data.p_id == 2){
				var p_name = '传说-贝琳博士英魂*5';
				var p_level = '二等奖';
			}else if(data.p_id == 3){
				var p_name = '勇士-克拉克英魂*5';
				var p_level = '三等奖';
			}else if(data.p_id == 4){
				var p_name = '钻石*100';
				var p_level = '安慰奖';
				...
				var p_name = '英雄-古德里安英魂*5';
				var p_level = '二等奖';
			}else if(data.p_id == 7){
				var p_name = '王者-西北风导弹【1阶】*1';
				var p_level = '一等奖';
			}else if(data.p_id == 8){
				var p_name = '金币*12120';
				var p_level = '安慰奖';
  ...
  MtimeSet = setTimeout(function() {
    ...
    if(k>=j){
      ...
      zui(_speed + 10,j,k);
		...
		var img_url = 'http://dev.static.yingxiong.com/qtdl/3.0/common/images/1212/'+k+'.png';
		  $('#p_img').attr('src',img_url);
		  if(k == 1){
			  var p_name = '烈火-柯尔德图纸*5';
			  var p_level = '三等奖';
