...
class SiteController extends \common\components\WapController
{
    ...
    public function actionIndex()
    {
        ...
        //最新新闻
        $zx=$this->getContentArr(\Yii::$app->params['ZUIXIN'],5);
        //新闻
        $xw=$this->getContentArr(\Yii::$app->params['XINWEN'],5);
        //公告
        $gg=$this->getContentArr(\Yii::$app->params['GONGGAO'],5);
        //攻略
        $gl=$this->getContentArr(\Yii::$app->params['GONGLUE'],5);
        //活动
        $hd=$this->getContentArr(\Yii::$app->params['HUODONG'],5);
