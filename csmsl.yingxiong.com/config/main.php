<?php
if (YII_DEV) {
    define('STATIC_DOMAIN','http://static.dev.yingxiong.com/csmsl/');
    define('VERSION', time());
} else if (YII_DEMO) {
    define('STATIC_DOMAIN','http://dev.static.yingxiong.com/dev/csmsl/');
    define('VERSION', time());
}else {
    define('STATIC_DOMAIN','//cdnstatic.yingxiong.com/csmsl/');
    ...
    'components' => [
        ...
        'urlManager' => [
            ...
            'rules' => [
                ...
                'info/list_<id:\d+>_<page:\d+>' => 'article/list',
                'm/info/list_<id:\d+>_<page:\d+>' => 'wap/article/list',
