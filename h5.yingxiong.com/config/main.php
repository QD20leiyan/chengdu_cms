<?php
if (YII_DEV) {
    define('STATIC_DOMAIN','http://static.dev.yingxiong.com/h5/');
    define('VERSION', time());
} else if (YII_DEMO) {
    define('STATIC_DOMAIN','http://dev.static.yingxiong.com/dev/h5/');
    define('VERSION', time());
} else {
    define('STATIC_DOMAIN','//cdnstatic.yingxiong.com/h5/');
   ...
   // 'defaultRoute' => 'site/index',
    ...
    'components' => [
        ...
        'urlManager' => [
            ...
            'suffix' => '.html',
            'rules' => [
                'index/<alias:\w+>/<file:\w+>/<num:\d+>' => 'index/index',
                'index/<alias:\w+>/<file:\w+>' => 'index/index',
            ],
        ],
        'view' => [
