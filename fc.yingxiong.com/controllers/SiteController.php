...
class SiteController extends PcController
{
    ...
    public function actionIndex()
    {
        ...
        $data['hd_img'] = $this->getRecommend('hd_img');  //活动推荐图片
        $data['hd_img'] = $data['hd_img'][0];
        ...
        $data['zxVideo'] = $this->getContentArr(202, 8);    //最新视频
        $data['tjVideo'] = $this->getContentArr(203, 8);    //推荐视频
        $data['jxVideo'] = $this->getContentArr(204, 8);    //教学视频
        $data['qwVideo'] = $this->getContentArr(205, 8);    //趣味视频
        $data['gfVideo'] = $this->getContentArr(206, 8);    //官方视频
        $data['zbVideo'] = $this->getContentArr(207, 8);    //热门直播
