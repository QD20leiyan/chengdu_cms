...
<head>
    ...
    <link rel="stylesheet" href="<?php echo STATIC_DOMAIN ?>kangshifu/css/share.css" />
    ...
    <script type="text/javascript" src="<?php echo STATIC_DOMAIN ?>kangshifu/js/share.js"></script>
...
<div class="box">
    <div class="top">
        <div class="top_1">
           ...
           <!-- <a class="price" href="javascript:;">用户名<span><?php /*echo $info->phone*/?></span></a>
            <a class="back" href="<?php /*echo Url::to('/game/handle/logout')*/?>">退出</a>-->
            <a class="price" href="javascript:;">用户名<span><?php echo $info->phone?></span></a>
        </div>
    </div>
    <img class="top_bg" src="<?php echo STATIC_DOMAIN ?>kangshifu/img/789.jpg" title="" alt=""  />
    <img class="middle_bg" src="<?php echo STATIC_DOMAIN ?>kangshifu/img/top_bg.png" title="" alt="" />
    <a class="title01 title" href="<?php echo Url::to('/game/handle/shop')?>">
        <span>积分商城</span>
    </a>
    <a class="title02 title" href="javascript:;">
        <span>分&nbsp;&nbsp;享</span>
    </a>
    <a class="title03 title" href="javascript:;" onclick="check()">
        <span>再玩一次</span>
    </a>
    ...
    <div class="dikuang">
        <img src="<?php echo STATIC_DOMAIN ?>kangshifu/img/download_1.png" title="" alt=""  />
    </div>
</div>
<script>
    $().ready(function(){
        ...
        if(score)
            alert('恭喜你获得了'+score+'积分');
    })
    function check(){
        var phone='<?php echo $info->phone?>';
        $.ajax({
            type: "GET",
            url: "<?php echo Url::to('/game/handle/check')?>",
            data: "phone=" + phone,
            dataType: "json",
            success: function (data) {
                if(data.status == 1){
                 window.location.href='http://game.yingxiong.com/fc_game/release/html5/v1/index.html?phone='+phone;
		}else{
                    alert(data.msg);
                }
            }
