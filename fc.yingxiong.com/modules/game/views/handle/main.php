...
<head>
    ...
    <link rel="stylesheet" href="<?php echo STATIC_DOMAIN ?>kangshifu/css/main_menu.css" />
    ...
    <script type="text/javascript" src="<?php echo STATIC_DOMAIN ?>kangshifu/js/main_menu.js"></script>
...
<a class="title01 title" href="http://game.yingxiong.com/fc_game/release/html5/v1/index.html?phone=<?php echo $info->phone?>">        
<span>小游戏赢积分</span>
    </a>
    <a class="title02 title" href="<?php echo Url::to('/game/handle/shop')?>">
        <span>CDkey换积分</span>
    </a>
    <a class="title03 title" href="<?php echo Url::to('/game/handle/shop')?>">
        <span>积分商城</span>
    </a>
