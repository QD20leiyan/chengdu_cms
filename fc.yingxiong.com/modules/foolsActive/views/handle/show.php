...
<div class="result">
    <div class="public">
        ...
        <div class="button">
            ...
            <div class="img">
                <img src="<?php echo STATIC_DOMAIN ?>yurenjie/images/beach.png" />
            </div>
            <div class="line line1"></div>
            <button type="button" class="start-btn"><a href="<?php echo $this->createUrl('handle/index')?>"><img src="<?php echo STATIC_DOMAIN ?>yurenjie/images/start-btn.png" /></a>                  </button>
        </div>
    </div>
</div>
  ...
  $().ready(function(){
    ...
    var option = {
        ...
        radar: [
            ...
            {
                indicator: [
                    <?php foreach (unserialize($result['result']) as $data){?>
        ...
        series: [
            {
                ...
                data: [
                    {
                        value: [<?php $common='';foreach (unserialize($result['result']) as $data){?><?php echo $common.$data['value'];$common=','?><?php }?>],
