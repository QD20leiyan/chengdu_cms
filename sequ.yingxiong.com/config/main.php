...
//            'identityCookie' => ['name' => '_identity-backend', 'httpOnly' => true, 'domain' => '.yingxiong.com'],
//        ],
//        'session' => [
//            // this is the name of the session cookie used for login on the backend
////            'name' => '_identity-backend',
//            'cookieParams' => ['name' => '_identity-backend', 'domain' => '.yingxiong.com', 'lifetime' => 0, 'httpOnly' => true],
//        ],
