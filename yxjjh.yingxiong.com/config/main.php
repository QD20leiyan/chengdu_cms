<?php
if (YII_DEV) {
    define('STATIC_DOMAIN','http://static.dev.yingxiong.com/yxjjh/');
    define('VERSION', time());
} else if (YII_DEMO) {
    define('STATIC_DOMAIN','http://dev.static.yingxiong.com/dev/yxjjh/');
    define('VERSION', time());
} else {
    define('STATIC_DOMAIN','http://cdnstatic.yingxiong.com/yxjjh/');
    ...
    'components' => [
        ...
        'urlManager' => [
            ...
            'rules' => [
                ...
                // 图片
                'image/list_<id:\d+>_<page:\d+>' => 'image/index',//变量修改会影响其他地方，慎重修改HomeController.php 429行
