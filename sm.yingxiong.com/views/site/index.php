...
<link rel="stylesheet" href="<?php echo STATIC_DOMAIN; ?>3.0/css/swiper-3.4.0.min.css" />
<div class="czymf" style="position: static;">
    <a class="dati" target="_blank" href="/special/dati.html">
        <img src="<?php echo STATIC_DOMAIN; ?>3.0/images/pc_dati.png"/>
    </a>
...
<!--            <img src="--><?php //echo STATIC_DOMAIN; ?><!--2.0/images/cz_pic_04.jpg" usemap="#Map" border="0" style="width:100%;">-->
            <img src="<?php echo STATIC_DOMAIN; ?>3.0/images/img11.jpg" usemap="#Map" border="0" style="width:100%;">
            ...
            <div class="czymf_play js_video_play" data-url="<?php echo $video[0]['url']; ?>"><img src="<?php echo STATIC_DOMAIN; ?>2.0/images/cz_play.png"></div>
            <!--
    ...
    <div class="news-cont">
        <div class="button">
            <a href="javascript:" id="yuyue"><i><label>预约人数： <b><?php echo $count; ?> </b>人</label></i></a>
...
<!--                    <li><a target="_blank" href="javascript:">攻略</a></li>-->
                ...
                <ul class="lis news-li show">
                    <?php if (!empty($zuixin)) { ?>
                        <?php if ($zuixin) {?>
                            <li><a target="_blank" href="<?php echo Cms::getUrl('article/detail', ['id' => $zuixin[0]->id, 'add_time' => $zuixin[0]->created_at]);?>"><i>【<?php echo $cate_arr[$zuixin[0]['category_id']];?>】</i><?php echo $zuixin[0]['title'] ?> </a><span>[<?php echo date('Y-m-d', $zuixin[0]->created_at) ?>]</span>
                                <p><?php echo mb_substr(strip_tags($zuixin[0]->contentMessage), 0, 60, 'utf-8')."..." ?></p>
                            </li>
                        <?php }?>
                        <?php foreach ($zuixin as $k => $v) {?>
                            <?php if ($k == 0) {continue;}?>
                            <li><a target="_blank" href="<?php echo Cms::getUrl('article/detail', ['id' => $v['id'], 'add_time' => $v['created_at']]);?>"><i>【<?php echo $cate_arr[$v['category_id']];?>】</i><?php echo $v['title']?> </a><span>[<?php echo date('Y-m-d', $v['created_at'])?>]</span></li>
                        <?php }?>
    ...
    <div class="zhu_banner">
        	<div class="zhu_title"><p>主播专区</p><a target="_blank" href="/special/zhubo.html">查看更多></a></div>
        	<div class="zhu_k">
        		<div class="zhu_pic">
	        		<ul class="swiper-wrapper">
	        			<?php foreach ($zhubo_lunbo as $k => $v) { ?>
	        				<li class="swiper-slide"><a target="_blank" href="<?php echo $v['url'] ?>"><img src="<?php echo $v['thumb'] ?>" /></a></li>
	        			<?php } ?>
	        		</ul>
...
<div class="yxyy_con">
    ...
    <div class="yxyy_con_info">
        ...
        <div class="yxyy_con_in_phone"><input type="text" placeholder="请输入手机号码" onkeyup="this.value=this.value.replace(/\D/g,'')"  onafterpaste="this.value=this.value.replace(/\D/g,'')"></div>
       	<div class="yxyy_con_in_email"><input type="text" placeholder="请输入邮箱"></div>
		<p class="yxyy_con_in_h">该邮箱将用于接收测试邀请，请确认信息真实有效</p>
        <div class="yxyy_con_in_btn">立即预约</div>
...
<div class="float" style="height:574px">
    <div class="float-cont">
        ...
        <p class="tap">
            <a target="_blank" href="http://l.taptap.com/k9bRaUI4"><img src="<?php echo STATIC_DOMAIN; ?>2.0/images/tap.png" /></a>
        </p>
        <div class="btns">
        ...
        <p class="tap">
            <a href="http://www.3839.com/a/88284.htm" target="_blank"><img src="<?php echo STATIC_DOMAIN; ?>/3.0/images/img22.jpg" /></a>
        </p>
        <div class="ico">
         ...
         <em style="font-style: normal;font-size:14px;color:#301b08;display: block;text-align: center;margin-left:11px;margin-top:-4px;">客服热线<br/>400-939-3333</em>
    </div>
...
<script type="text/javascript">
    ...
    $(".yxyy_con_in_btn").on("click",function(e){
        ...
        if(phoneLen!=11){
            ...
            var type = "ios";
            $.post('<?php echo Url::to(['site/subscribe']) ?>', {phone:phone, email:email,cms_csrf:cms_csrf, type:type}, function (data) {
                if (data.status == 0) {
                    alert("预约成功");
                    $(".yxyy_tk").hide();
                    $(".yxyy_con").hide();
...
<script type="text/javascript" src="<?php echo STATIC_DOMAIN; ?>3.0/js/swiper-3.4.0.min.js"></script>
<script type="text/javascript">
	var mySwiper = new Swiper(".zhu_pic" , {
		loop:true,
