<?php
if (YII_DEV) {
    define('STATIC_DOMAIN','http://static.dev.yingxiong.com/newyear/');
    define('VERSION', time());
} else if (YII_DEMO) {
    define('STATIC_DOMAIN','http://dev.static.yingxiong.com/dev/newyear/');
    define('VERSION', time());
} else {
    define('STATIC_DOMAIN','http://cdnstatic.yingxiong.com/newyear/');
   ...
   // 'defaultRoute' => 'site/index',
    ...
    'components' => [
        ...
        'redis' =>[
            ...
            'hostname' => '192.168.72.128',  //你的redis地址
