...
<body>
	<div class="Valentine">
		<div class="Valentine_page1 Valentine_sjjy_page1">
			<!-- <div class="Valentine_flash">
				<object type="application/x-shockwave-flash" id="liveplayer" name="liveplayer" align="middle" data="images/Valentine.swf" width="100%" height="100%">
			...
			<div class="Valentine_page1_main">
				<a href="http://ddd2.yingxiong.com/" class="Valentine_back"></a>
				<a href="index.html" class="Valentine_logo"><img src="<?php echo STATIC_DOMAIN?>2.0/images/ddd_logo_valentine.png?<?= VERSION?>" alt=""></a>
			</div>
		</div>
		...
		<div class="Valentine_fixed">
			<img src="<?php echo STATIC_DOMAIN?>2.0/images/Valentine_ewm.jpg?<?= VERSION?>" alt="" class="Valentine_ewm">
			<a href="https://lnk0.com/lApwZh" class="Valentine_ios"><img src="<?php echo STATIC_DOMAIN?>2.0/images/Valentine_ios.png?<?= VERSION?>" alt=""></a>
			<a href="http://cdn.yingxiong.com/ddd2/ddd2-shij-P32620A-0120.apk" class="Valentine_android"><img src="<?php echo STATIC_DOMAIN?>2.0/images/Valentine_android.png?<?= VERSION?>" alt=""></a>
			<a href=""></a>
		</div>
	</div>
