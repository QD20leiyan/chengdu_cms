...
<div class="we-chart-box">
    <div class="we-chart">
        ...
        <img src="<?php echo STATIC_DOM;?>4.0/common/images/ewm_wx.jpg" alt="极无双二维码">
    </div>
</div>
<!--视频-->
<!--<div id="video_tck">-->
...
<script src="<?php echo STATIC_DOM;?>4.0/m/js/jquery.fittext.js"></script>
<script src="<?php echo STATIC_DOM;?>4.0/m/js/js.js"></script>
