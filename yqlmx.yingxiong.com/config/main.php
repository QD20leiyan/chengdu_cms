<?php
if (YII_DEV) {
    define('STATIC_DOMAIN','http://static.dev.yingxiong.com/yqlmx/');
    define('VERSION', time());
} else if (YII_DEMO) {
    define('STATIC_DOMAIN','http://dev.static.yingxiong.com/dev/yqlmx/');
    define('VERSION', time());
} else {
    define('STATIC_DOMAIN','http://cdnstatic.yingxiong.com/yqlmx/');
    ...
    'components' => [
        ...
        'urlManager' => [
            ...
            'rules' => [
                ...
                '<name:tycpc|jpcpc|ppcpc|stpc>'=>'site/index',
                '<name:tycwap|ppcwap|stwap|jpcwap|wxone|wxtwo>'=>'wap/site/index',
            ],
        ],
        'view' => [
