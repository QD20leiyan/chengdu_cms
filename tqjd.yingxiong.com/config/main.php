<?php
if(YII_DEV){
    define('STATIC_DOMAIN','http://static.dev.yingxiong.com/tqjd/');
    define('VERSION', time());
}elseif (YII_DEMO){
    define('STATIC_DOMAIN','http://dev.static.yingxiong.com/tqjd/');
    define('VERSION', time());
}else{
    define('STATIC_DOMAIN','//cdnstatic.yingxiong.com/tqjd/');
