<?php
if (YII_DEV) {
    define('STATIC_DOMAIN','http://static.dev.yingxiong.com/lszt/');
    define('VERSION', time());
} else if (YII_DEMO) {
    define('STATIC_DOMAIN','http://dev.static.yingxiong.com/dev/lszt/');
    define('VERSION', time());
} else {
    define('STATIC_DOMAIN','http://cdnstatic.yingxiong.com/lszt/');
   ...
   // 'defaultRoute' => 'site/index',
    ...
    'components' => [
        ...
        'urlManager' => [
            ...
            'suffix' => '.html',
            'rules' => [
                'cover<id:\d+>' => 'site/cover',
                'm/cover<id:\d+>' => 'wap/site/cover',
