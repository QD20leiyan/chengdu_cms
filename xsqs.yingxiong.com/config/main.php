<?php
if (YII_DEV) {
    define('STATIC_DOMAIN','http://static.dev.yingxiong.com/xsqs/');
} else if (YII_DEMO) {
    define('STATIC_DOMAIN','http://dev.static.yingxiong.com/xsqs/');
} else {
    define('STATIC_DOMAIN','http://cdnstatic.yingxiong.com/xsqs/');
}
